...
\title {
    ...
    % Full name - SHORTNAME
    \documentTitle {Software Verification and Validation}
    \documentGroup {2}
...
The detailed test instructions for the test cases introduced in ref. 1 are shown in appendices below. Test cases are documented in the form of steps that are carried out by the tester. Before a function test is carried out, the preconditions described in the “Start state” should be met. When steps are initiated with “Check that” they describe an expected result of the system, and the testers task is to make sure that the expected result is given.
...
\subsection{Login and Logout}
	\begin{itemize}
		...
		\begin{enumerate}
			\item Access the login page. 
			\item Login with username “Alex” and password “123ABCde”. 
			\item Check that a new page is shown. 
...
\subsection{User}
\begin{itemize}
		\item \textbf{FT12: Users can submit a time report.}\newline
		\textbf{Start state:} User is logged in. \newline
		...
		\item \textbf{FT13: Can see a summarized view of current user time reports.}\newline
		\textbf{Start state:} User is logged in.  \newline
		...
		\item \textbf{FT14: Can edit a submitted report if it is not signed by a Project Leader.}\newline
		...
		\item \textbf{FT15: Cannot edit a submitted report if it is signed by a Project Leader.}\newline
...
\begin{itemize}
		\item \textbf{FT16: Can see a summarized view of the users time reports}\newline
		\textbf{Start state:} Project Leader is logged in. It exists users in the database.\newline
		...
		\item \textbf{FT17: Can see all users and their roles.}\newline
		...
		\item \textbf{FT18: Can change roles on other users.}\newline
		...
		\item \textbf{FT19: Cannot change roles on themselves} \newline
		...
		\item \textbf{FT20: Cannot  change other Project Leaders roles.}\newline
		...
		\item \textbf{FT21: Can sign time reports}\newline
		...
		\item \textbf{FT22: Can reverse an signed time report making it editable again.}\newline
...
\begin{itemize}
		\item \textbf{FT23: Can access administration page.} \newline
 ...
 \newline
		...
		\item \textbf{FT24: Can add a new user.} \newline
		...
		\item \textbf{FT25: Cannot add a new user with existing username.} \newline
		...
		\textbf{End state:} The site displays a message informing that the use was not created.
		\begin{enumerate}
			\item Click the “add a user” button.
		...
		\item \textbf{FT26: Can remove a user.} \newline
		\textbf{Start state:} Logged in with the administrator account and on the Administration page. User “Alex” exists in the database. \newline
		...
		\item \textbf{FT27: Can see a summarized view of users time reports.} \newline
		...
		\item \textbf{FT28: Can change the roles of all users.} \newline
		...
		\item \textbf{FT29: Can change the roles of all Project Leaders.} \newline
		...
		\item \textbf{FT30: Can view all users as a list.} \newline
