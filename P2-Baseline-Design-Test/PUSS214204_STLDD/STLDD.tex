...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{images/UML_Diagram.png}
    \caption{Diagram showing an overview of the classes involved in the system}
...
The User relation contains all registered users together with user specific information such as password and email. A user belonging to the project may be assigned a role under the role attribute. The userName attribute is used as the primary key, making every username unique. The appearance of the table can be viewed in Figure 3.
