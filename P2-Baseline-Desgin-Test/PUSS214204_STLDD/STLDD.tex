...
This file contains the view that shows a collection of the users submitted reports.
...
This view is used by users that want to edit their previous reported time reports.
...
This view is used by all users to change their password.
