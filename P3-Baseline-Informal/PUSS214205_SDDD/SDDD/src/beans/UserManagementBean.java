...
public class UserManagementBean implements Serializable {
    ...
    private Map<String, String> userList = new HashMap<String, String>(); //Map containing the elements <Username, Role>
    ...
    public void populateBean(Map<String, String> map){
    	userList.putAll(map); //Fills the map with user input.
    }
}