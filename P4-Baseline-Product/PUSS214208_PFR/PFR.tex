...
\section{Project Overview \label{overview}}
    ...
    \subsection{Online Communication \label{communication}}
        ...
        and, as much as possible have the camera on, this did not happen. %%Något känns udda med den här meningen men kan inte sätta fingret på vad.
        The majority of the time during the project group meetings was
        spent as a monologue from the president with just a few cameras on. %Ändrade från handful till few, handful låter för generöst, ändra tillbaks om du vill
...
\section{Analysis \label{analysis}}
    ...
    \subsection{Phase 3. Week 8-9 \label{analys_phase3}}
        ...
        \begin{itemize}
            ...
            \item Lack of communication between the subgroups of DG which resulted in
                    extra work, such as different variable names between frontend/backend. %Något tokig här oxå, men är inte säker på hur det ska rättas till
    ...
    \subsection{Version Control \& Configuration Management}
        ...
        commit to the project repository. While the cause of this is unknown we consider %Denna meningen känns oxå tokig
