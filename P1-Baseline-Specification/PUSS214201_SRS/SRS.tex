...
Users who have forgotten their passwords should be able to receive, from the server, a newly generated password to the email connected to their username. The users old password in the database is then overwritten with the newly generated password.
