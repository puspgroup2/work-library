...
\begin{tabular}{ l | l | l | l }
    ...
    0.4 & 2021-02-10 & PG & Fixed typos and clarified the usage of E-PUSS. \\
\end{tabular}
...
\section{Follow up and Quality Evaluation \label{followup}}
    ...
    \subsection{Informal Review \label{informalreview}}
        ...
        should ready no later than 17:00 the day before the review. PG is responsible
        ...
        found and then the reviewees will get an opportitemy to reply and have a discussion
        ...
        \begin{enumerate}
            ...
            \item ECG evalutes the report and decides if it warrants a fix.
                \begin{enumerate}
                    ...
                    \item If the error is found to ilegitimate, e.g it occured during an outdated test, the report is discarded.
                \end{enumerate}
        \end{enumerate}
